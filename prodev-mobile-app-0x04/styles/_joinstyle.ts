...
const styles = StyleSheet.create({
  ...
  signupgroup: { flexDirection: 'row', justifyContent: 'center', position: 'absolute', left: 77, right: 76, bottom: 33 },
  signupTitleText: { fontSize: 18, fontWeight: "400" },
  signupSubTitleText: { fontSize: 18, fontWeight: "600", color: '#FFA800' },
  dividerGroup: { flexDirection: 'row', alignItems: 'center', columnGap: 10, marginBottom: 25, marginTop: 29 },
  divider: { borderWidth: 1, flex: 1, borderColor: '#e6e6e6' },
  dividerText: { fontSize: 17, fontWeight: "500", fontVariant: ['small-caps'], color: '#C2C2C2' },
